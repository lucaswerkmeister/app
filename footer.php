...
<footer class="footer">
	...
	<div class="footer__info">
        ...
        <?php endif; ?>
				<li class="footer__menu-item"><a class="footer__menu-link" href="https://wikimedia.de/de/impressum" target="_blank"><?php echo $datenschutz; ?></a></li>
...
<footer class="footer--app">
  <nav class="footer--app__nav">
      <ul class="footer--app__menu">
          <li class="footer--app__menu-item"><a class="footer--app__menu-link" href="https://wikimedia.de/de/impressum" target="_blank"><?php echo $datenschutz; ?></a></li>
